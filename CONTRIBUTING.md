...
- Ensure any install or build dependencies are removed before the end of the layer when doing a 
   build.
- Update the README.md with details of changes to the interface, including new features like Secure Share, new environment variables (e.g. Supabase keys), exposed ports, useful file locations, and container parameters.
