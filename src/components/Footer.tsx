      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex justify-center items-center">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-vison-dark-charcoal font-nunito">Vison</h3>
        ...
        <div className="mt-6 text-center text-xs text-vison-charcoal/50 font-nunito">
